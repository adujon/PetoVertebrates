...
#export the best model
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_neoplasia_OU , "Compton_mammals_neoplasm_logMass_logMaxLongevity.rds")
...
#export the best model
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_malignant_OU  , "Compton_mammals_malignant_logMass_logMaxLongevity.rds")
...
write.csv(effect_sizes_summary, "Compton et al mammals.csv",  row.names = F)
