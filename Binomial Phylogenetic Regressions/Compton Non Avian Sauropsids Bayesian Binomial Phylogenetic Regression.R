...
setwd(export_dir)
saveRDS(fit_logmass_neoplasia_OU , "Compton_non_avian_sauropsids_neoplasm_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_malignant_OU, "Compton_non_avian_sauropsids_malignant_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_neoplasia_OU , "Compton_non_avian_sauropsids_neoplasm_logMaxLongevity.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_malignant_OU, "Compton_non_avian_sauropsids_malignant_logMaxLongevity.rds")
...
#export the best model
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_neoplasia_OU , "Compton_non_avian_sauropsids_neoplasm_logMass_logMaxLongevity.rds")
...
#export the best model
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_malignant_OU  , "Compton_non_avian_sauropsids_malignant_logMass_logMaxLongevity.rds")
...
write.csv(effect_sizes_summary, "Compton et al non_avian_sauropsids.csv",  row.names = F)
