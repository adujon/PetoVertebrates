...
effect_sizes_tmp <- data.frame(Dataset = "Kapsetaki et al.",
...
setwd(export_dir)
saveRDS(fit_logmass_neoplasia_OU , "Kapsetaki_birds_neoplasm_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_malignant_OU, "Kapsetaki_birds_malignant_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_neoplasia_OU , "Kapsetaki_birds_neoplasm_logMaxLongevity.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_malignant_OU, "Kapsetaki_birds_malignant_logMaxLongevity.rds")
...
effect_sizes_tmp_logMass <- data.frame(Dataset = "Kapsetaki et al.",
                                       Tumor_Type = "Neoplasia",
...
effect_sizes_tmp_logMaxLongevity <- data.frame(Dataset = "Kapsetaki et al.",
                                               Tumor_Type = "Neoplasia",
...
effect_sizes_tmp_logMass_int <- data.frame(Dataset = "Kapsetaki et al.",
                                           Tumor_Type = "Neoplasia",
                                           Variable = "logMass * logMaxLongevity (effect size for logMass)",
...
effect_sizes_tmp_logMaxLongevity_int <- data.frame(Dataset = "Kapsetaki et al.",
                                                   Tumor_Type = "Neoplasia",
...
#export the best model
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_neoplasia_OU , "Kapsetaki_birds_neoplasm_logMass_logMaxLongevity.rds")
...
#export the best model
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_malignant_OU  , "Kapsetaki_birds_malignant_logMass_logMaxLongevity.rds")
...
write.csv(effect_sizes_summary, "Kapsetaki et al birds.csv",  row.names = F)
