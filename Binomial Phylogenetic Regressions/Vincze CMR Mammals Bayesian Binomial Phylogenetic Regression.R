...
effect_sizes_tmp <- data.frame(Dataset = "Vinzce et al. CMR",
...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_malignant_OU, "Vincze_CMR_mammals_malignant_logMass.rds")
...
#combine the results into a vector
effect_sizes_tmp <- data.frame(Dataset = "Vincze et al. CMR",
                               Tumor_Type = "Lethal",
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_malignant_OU, "Vincze_CMR_mammals_malignant_logMaxLongevity.rds")
...
effect_sizes_tmp_logMass <- data.frame(Dataset = "Vinzce et al. CMR",
                                       Tumor_Type = "Lethal tumour",
...
effect_sizes_tmp_logMaxLongevity <- data.frame(Dataset = "Vinzce et al. CMR",
                                               Tumor_Type = "Lethal tumour",
...
effect_sizes_tmp_logMass_int <- data.frame(Dataset = "Vinzce et al. CMR",
                                           Tumor_Type = "Lethal tumour",
                                           Variable = "logMass * logMaxLongevity (effect size for logMass)",
...
effect_sizes_tmp_logMaxLongevity_int <- data.frame(Dataset = "Vinzce et al. CMR",
                                                   Tumor_Type = "Lethal tumour",
...
setwd(export_dir)
saveRDS(fit_logmass_logmaxlongevity_malignant_OU  , "Vincze_CMR_mammals_malignant_logMass_logMaxLongevity.rds")
...
write.csv(effect_sizes_summary, "Vincze et al mammals CMR.csv", row.names = F)
