...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_neoplasia , "Compton_mammals_neoplasm_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_malignant, "Compton_mammals_malignant_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_neoplasia , "Compton_mammals_neoplasm_logMaxLongevity.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_malignant, "Compton_mammals_malignant_logMaxLongevity.rds")
