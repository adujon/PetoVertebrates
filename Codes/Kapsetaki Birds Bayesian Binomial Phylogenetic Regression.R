...
data$logMaxLongevity<- log(data$max_longevity) #log transform the Max Longevity in months
...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_neoplasia , "Kapsetaki_birds_neoplasm_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logmass_malignant, "Kapsetaki_birds_malignant_logMass.rds")
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_neoplasia , "Kapsetaki_birds_neoplasm_logMaxLongevity.rds")

##############################################################################################
#######################  Modelling the effect of logMaxLongevityon malignancy #######################
##############################################################################################
...
#export the model
setwd(export_dir)
saveRDS(fit_logMaxLongevity_malignant, "Kapsetaki_birds_malignant_logMaxLongevity.rds")
